...
|   ├── instructions/       # Contribution and issue templates
|   └── prompts/            # AI-assisted code generation prompts
├── docs/                   # Documentation files
├── srcs/                     
│   ├── apps/               # Frontend and backend applications
│   │   ├── Angular/        # Angular SPA client
│   │   └── Identity/       # Blazor SSR Identity Provider
|   ├── infra/
│   │   ├── Gateway/        # .NET YARP API Gateway
│   │   ├── Migrator/       # .NET Database Migrator
│   │   └── Orchestrator/   # .NET Aspire orchestrator
│   ├── services/
│   │   ├── Admin/          # Administration microservice
│   │   ├── Identity/       # Identity microservice
│   │   ├── Notify/         # Notification microservice
│   │   └── Payment/        # Payment microservice
│   └── shared/             # Shared backend libraries
└── tests/                  
    ├── Playwright/         # Playwright Testing Framework for E2E tests
    ├── Srv.Admin/          # Aspire Testing Framework: Admin microservice
    ├── Srv.Identity/       # Aspire Testing Framework: Identity microservice
    ├── Srv.Notify/         # Aspire Testing Framework: Notification microservice
    └── Srv.Payment/        # Aspire Testing Framework: Payment microservice
```
