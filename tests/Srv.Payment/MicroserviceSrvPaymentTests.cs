...
{
    /// <summary>
    /// This is a required test class to ensure the "srv-payment" service is started in the Aspire Testing App Host.
    /// We should clone this pattern for each microservice to validate their startup within the test environment.
    /// </summary>
    [TestClass]
    public class MicroserviceSrvPaymentTests : MicroserviceSrvPaymentBaseTest
    {
        [AssemblyInitialize]
